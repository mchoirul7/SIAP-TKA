...
export type AccentTone = "brand" | "emerald" | "neon" | "rose" | "sky" | "amber" | "violet" | "slate";

/** Latar dan garis kartu lembut. */
export const toneSurface: Record<AccentTone, string> = {
  brand: "border-brand-200 bg-brand-50",
  emerald: "border-emerald-200 bg-emerald-50",
  neon: "border-lime-200 bg-lime-50",
...
export const toneIconBox: Record<AccentTone, string> = {
  ...
  neon: "bg-gradient-to-br from-lime-300 to-green-500 text-ink-900",
...
export const toneButton: Record<AccentTone, string> = {
  ...
  neon: "bg-gradient-to-r from-lime-300 to-green-500 text-ink-900",
...
export const toneTag: Record<AccentTone, string> = {
  ...
  neon: "bg-lime-50 text-green-900 ring-1 ring-inset ring-lime-200",
...
export const toneChip: Record<AccentTone, string> = {
  ...
  neon: "bg-lime-100 text-green-900 ring-1 ring-inset ring-lime-300",
